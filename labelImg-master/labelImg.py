...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, default_filename=None, default_prefdef_class_file=None, default_save_dir=None):
        ...
        # Create a widget for edit and diffc button
        self.covered_button = QCheckBox(get_str('useCovered'))
        self.covered_button.setChecked(False)
        self.covered_button.stateChanged.connect(self.button_state_covered)

        # Add some of widgets to list_layout
        list_layout.addWidget(self.edit_button)
        list_layout.addWidget(self.diffc_button)
        list_layout.addWidget(self.covered_button)
    ...
    # Add chris
    def button_state_covered(self, item=None):
        """ Function to handle difficult examples
        Update on each object """
        if not self.canvas.editing():
            return
        ...
        covered = self.covered_button.isChecked()
        ...
        # Checked and Update
        try:
            if covered != shape.covered:
                shape.covered = covered
                self.set_dirty()
            else:  # User probably changed item visibility
                self.canvas.set_shape_visible(shape, item.checkState() == Qt.Checked)
        except:
    ...
    def load_labels(self, shapes):
        s = []
        for label, points, line_color, fill_color, difficult, covered in shapes:
    ...
    def label_selection_changed(self):
        ...
        if item and self.canvas.editing():
            ...
            self.covered_button.setChecked(shape.covered)

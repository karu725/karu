...
class PascalVocWriter:
    ...
    def add_bnd_box(self, x_min, y_min, x_max, y_max, name, difficult, covered):
        bnd_box = {'xmin': x_min, 'ymin': y_min, 'xmax': x_max, 'ymax': y_max}
        bnd_box['name'] = name
        bnd_box['difficult'] = difficult
        bnd_box['covered'] = covered
    ...
    def append_objects(self, top):
        for each_object in self.box_list:
            ...
            covered = SubElement(object_item, 'covered')
            covered.text = str(bool(each_object['covered']) & 1)
...
class PascalVocReader:
    ...
    def add_shape(self, label, bnd_box, difficult, covered):
        ...
        self.shapes.append((label, points, None, None, difficult, covered))
    ...
    def parse_xml(self):
        ...
        for object_iter in xml_tree.findall('object'):
            ...
            covered = False
            if object_iter.find('covered') is not None:
                covered = bool(int(object_iter.find('covered').text))
            self.add_shape(label, bnd_box, difficult, covered)
        return True
